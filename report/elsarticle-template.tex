...
\title{Seminar Paper \\ TITLE TITLE TITLE TITLE}
\author[label1]{Karsten Paul (333092)}
\address[label1]{Computational Engineering Science (M.Sc.) \\ RWTH Aachen}
...
Sample text. Sample text. Sample text. Sample text. Sample text. Sample text. 
Sample text. Sample text. Citation of Einstein paper~ \\\citet{HO_PH_BF}. \\
\citet{PH_dynBF}
